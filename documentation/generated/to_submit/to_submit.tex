...
Takových aplikací je na internetu už spoustu, ale všechny jsou online.
Tato aplikace je odlišná od těch ostatních tím, že není potřeba být připojen k internetu pro její fungování.
Je proto užitečná pro uživatele, kteří by chtěli využít dlouhé cesty metrem nebo jiné situace bez možnosti připojení k webu a učit se slovíčka či jiné věci.
Díky možnosti exportu a importu kartiček je pak možné si před takovouto situací překopírovat data z jednoho zařízení do druhého.
Zatím je tato aplikace určena pouze pro počítače a notebooky.
