...
$(document).ready(function() {
    ...
    $('#create_card_button').click( function() {
    ...
    $('#test_browse_button').click( function() {
        showOneItem('test_browse');
        $('#browse_window').hide();
        $('#start_browse_button').click( function() {
            $('#start_browse').hide();
            $('#browse_window').show();
        });
        $('#start_browse').show();
    });
    $('#test_choices_button').click( function() {
        showOneItem('test_choices');
        $('#choices_window').hide();
        $('#start_choices_button').click( function() {
            $('#start_choices').hide();
            $('#choices_window').show();
    ...
    $('#test_write_button').click( function() {
        showOneItem('test_write');
        $('#write_window').hide();
        $('#start_write_button').click( function() {
            $('#start_write').hide();
            $('#write_window').show();
        });
        $('#start_write').show();
